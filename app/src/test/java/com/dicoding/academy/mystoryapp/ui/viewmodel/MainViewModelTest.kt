...
import com.dicoding.academy.mystoryapp.DataDummy
import com.dicoding.academy.mystoryapp.MainDispatcherRule
...
import com.dicoding.academy.mystoryapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    @Mock
    private lateinit var storyListRepository: UserRepository
    ...
    fun `when Get Story List Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyListRepository.getStoryList()).thenReturn(expectedStory)
        val mainViewModel = MainViewModel(storyListRepository)
